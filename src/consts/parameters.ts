...
export const contractConst = "0x846168fB495c152455b01FC5ddC21F3e7e75DaF0";

// The name of the chain your contract is deployed to.
// Refer to README.md on how to specify the chain name.
export const chainConst = "X1 testnet";
...
export const clientIdConst = "2636c38b6c1ff70f7d8a6f43f688586b"; // Client ID
